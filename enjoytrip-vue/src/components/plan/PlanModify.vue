<template>
  <div class="regist">
    ...
    <div class="regist_form">
      ...
      <div>
        <label for="public">
          <b-icon icon="unlock-fill" font-scale="1"></b-icon>공개
          <input
            type="radio"
            id="public_yes"
            name="isPublic"
            ...
            :checked="article.isPublic === '1'"
          />
        </label>
        <label for="private">
          <b-icon icon="lock-fill" font-scale="1"></b-icon>비공개
          <input
            type="radio"
            id="public_no"
            name="isPublic"
...
export default {
  ...
  methods: {
    ...
    checkValue() {
      ...
      err &&
        !this.article.endDate &&
        ((msg = "종료일 입력해주세요"),
        (err = false),
        this.$refs.endDate.focus());
      err &&
        !this.article.isPublic &&
