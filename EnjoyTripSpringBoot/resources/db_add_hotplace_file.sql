...
-- -----------------------------------------------------
-- Table `enjoytrip`.`board_share_trip`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enjoytrip`.`board_share_trip` (
  ...
  INDEX `user_id_to_board_share_trip_user_id_fk_idx` (`user_id` ASC) VISIBLE,
  CONSTRAINT `user_id_to_board_share_trip_user_id_fk`
    FOREIGN KEY (`user_id`)
...
CREATE TABLE IF NOT EXISTS `enjoytrip`.`comment` (
  `user_id` VARCHAR(100) NOT NULL,
  `board_share_trip_id` INT NOT NULL,
  `id` INT NOT NULL AUTO_INCREMENT,
  `content` VARCHAR(300) NOT NULL,
  `write_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `like` INT NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  INDEX `board_share_trip_to_comment_board_share_trip_id_fk_idx` (`board_share_trip_id` ASC) VISIBLE,
  CONSTRAINT `board_share_trip_to_comment_board_share_trip_id_fk`
    FOREIGN KEY (`board_share_trip_id`)
    REFERENCES `enjoytrip`.`board_share_trip` (`id`)
    ON DELETE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
CREATE TABLE IF NOT EXISTS `enjoytrip`.`hotplace` (
  ...
  PRIMARY KEY (`id`),
  INDEX `user_id_to_hotplace_user_id_fk_idx` (`user_id` ASC) VISIBLE,
  INDEX `attraction_info_hotplacel_data_num_fk_idx` (`data_num` ASC) VISIBLE,
  CONSTRAINT `attraction_info_hotplacel_data_num_fk`
    FOREIGN KEY (`data_num`)
    REFERENCES `enjoytrip`.`attraction_info` (`content_id`)
    ON DELETE CASCADE,
...
-- -----------------------------------------------------
-- Table `enjoytrip`.`likestamp`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enjoytrip`.`likestamp` (
  `user_id` VARCHAR(100) NOT NULL,
  `hotplace_id` INT NOT NULL,
  PRIMARY KEY (`user_id`, `hotplace_id`),
  INDEX `hotplace_id_to_likestamp_hotplace_id_fk_idx` (`hotplace_id` ASC) VISIBLE,
  CONSTRAINT `hotplace_id_to_likestamp_hotplace_id_fk`
    FOREIGN KEY (`hotplace_id`)
    REFERENCES `enjoytrip`.`hotplace` (`id`)
    ON DELETE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
CREATE TABLE IF NOT EXISTS `enjoytrip`.`notice` (
  ...
  PRIMARY KEY (`id`),
  INDEX `user_id_to_notice_user_id_fk_idx` (`user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `enjoytrip`.`plan` (
  ...
  PRIMARY KEY (`id`),
  INDEX `user_id_to_plan_user_id_fk_idx` (`user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `enjoytrip`.`plan_detail` (
  ...
  INDEX `plan_id_to_plan_detail_plan_id_fk_idx` (`plan_id` ASC) VISIBLE,
  INDEX `attraction_info_content_id_to_plan_detail_data_num_fk_idx` (`data_num` ASC) VISIBLE,
  CONSTRAINT `attraction_info_content_id_to_plan_detail_data_num_fk`
    FOREIGN KEY (`data_num`)
    REFERENCES `enjoytrip`.`attraction_info` (`content_id`)
    ON DELETE CASCADE,
  CONSTRAINT `plan_id_to_plan_detail_plan_id_fk`
    FOREIGN KEY (`plan_id`)
    REFERENCES `enjoytrip`.`plan` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;


-- -----------------------------------------------------
-- Table `enjoytrip`.`hotplace_file`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `enjoytrip`.`hotplace_file` (
  `hotplace_id` INT NOT NULL,
  `fid` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(100) NOT NULL,
  `path` VARCHAR(200) NOT NULL,
  PRIMARY KEY (`fid`),
  INDEX `hotplace_id_to_hotplace_file_hotplace_hotplace_id_fk_idx` (`hotplace_id` ASC) VISIBLE,
