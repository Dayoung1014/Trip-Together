package edu.ssafy.enjoytrip.board.aop;
...
@Component
@Aspect
public class LoggingAspect_board {

	private Logger logger = LoggerFactory.getLogger(LoggingAspect_board.class);

	@Before(value = "execution(* edu.ssafy.enjoytrip.board.model..Board*.*(..))")
	...
	@Around(value = "execution(* edu.ssafy.enjoytrip.board.model..Board*.*(..))")
	...
	@AfterReturning(value = "execution(* edu.ssafy.enjoytrip.board.model..Board*.list*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* edu.ssafy.enjoytrip.board.model..Board*.list*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* edu.ssafy.enjoytrip.board.model..Board*.list*(..))")
