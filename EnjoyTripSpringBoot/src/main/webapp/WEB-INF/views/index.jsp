...
<html>
  ...
  <body>
          ...
          >
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="<%= root %>/img/top7.flower.png" class="d-block w-100" alt="..." />
              </div>
              <div class="carousel-item">
                <img src="<%= root %>/img/junimg12.png" class="d-block w-100" alt="..." />
              </div>
              <div class="carousel-item">
                <img src="<%= root %>/img/junimg10.png" class="d-block w-100" alt="..." />
              </div>
            </div>
            <button
            ...
            <div class="modal-body">
              ...
              <div class="card">
                <div style="width: fit-content">
                  <img src="<%= root %>/img/junimg04.png" class="card-img-top" alt="..." />
                </div>
      ...
      <div class="row m-1">
        <div class="col-9">
          <div class="row row-cols-1 row-cols-lg-3 m-3 flex-nowrap justify-content-md-center">
            ...
            >
              <img src="<%= root %>/img/junimg03.png" class="card-img-top" />
            </div>
            <!--우리지역 관광지 끝-->
            <!--우리지역 관광지 시작-->
            <div
              ...
              data-bs-target="#area-trip-modal"
            >
              <img src="<%= root %>/img/junimg05.png" class="card-img-top" />
            </div>
            <!--우리지역 관광지 끝-->
            <!--우리지역 관광지 시작-->
            <div
              ...
              data-bs-target="#area-trip-modal"
            >
              <img src="<%= root %>/img/junimg06.jpg" class="card-img-top" />
            </div>
            <!--우리지역 관광지 끝-->
          </div>
        </div>
    ...
    <script src="<%= root %>/js/indexfunction.js"></script>
